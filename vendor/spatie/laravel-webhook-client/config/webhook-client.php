...
return [
    'configs' => [
        [
             ...
             */
            'signature_validator' => \App\Webhook\SignatureValidator::class,
             ...
             */
            'process_webhook_job' => \App\Webhook\ProcessWebhookJob::class,

            'webhook_response' => \App\Webhook\RespondsToWebhook::class,
        ],
    ],
];